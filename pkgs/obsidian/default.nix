{ stdenv, fetchurl, lib, makeWrapper, electron_25, makeDesktopItem, imagemagick
...
let
  ...
  src = fetchurl {
    ...
    hash = if stdenv.isDarwin then
      "sha256-ydLWr+Snkza9G+R7HbPuUdoZsL25Uj+KDos67Mq/urY="
    else
      "sha256-F7nqWOeBGGSmSVNTpcx3lHRejSjNeM2BBqS9tsasTvg=";
  };
