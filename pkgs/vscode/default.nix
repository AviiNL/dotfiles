{ stdenv, lib, callPackage, fetchurl, nixosTests, srcOnly, isInsiders ? false
...
, sourceExecutableName ? "code"
  + lib.optionalString (isInsiders && stdenv.isLinux) "-insiders"
, commandLineArgs ? "", useVSCodeRipgrep ? stdenv.isDarwin }:
...
let
  ...
  sha256 = {
    x86_64-linux =
      "sha256-i8eLGs3ucsi/seeDX7zgnRizrwu63Edu9PQy0yBk02M="; # 1vdgc4mnysij2sf87d5dfh0yw9j2a58lvmnwzzsj1icaydhkhfjy
